...
interface SmartFiltersProps {
  ...
  sortBy: 'recent' | 'oldest' | 'most-words' | 'least-words' | 'name-asc' | 'name-desc'
...
export function SmartFilters({
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      ...
      <div className={`grid grid-cols-1 ${hasCredits ? 'md:grid-cols-3' : 'md:grid-cols-2'} gap-4 mb-4`}>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            ...(hasCredits ? [
              ...
              { value: 'least-words', label: 'Least Words' },
            ] : []),
