...
export function ExportOptions({
  ...
  const handleExport = async (format: 'pdf' | 'docx' | 'markdown' | 'googledoc') => {
    setLoading(format);
    try {
      let result;
      ...
      switch (format) {
        ...
        case 'googledoc':
          result = await exportToGoogleDoc({
            content,
            template,
            userBranding,
            subscriptionTier,
  ...
  const estimatedSizes = {
    pdf: estimateFileSize(content, 'pdf'),
    docx: estimateFileSize(content, 'docx'),
    markdown: estimateFileSize(content, 'markdown'),
    googledoc: estimateFileSize(content, 'googledoc'),
  };
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-gray-500">
                {formatFileSize(estimatedSizes.pdf)} • Printable format
              </div>
            </div>
          </div>
          {loading === 'pdf' ? (
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <div className="text-sm text-gray-500">
                {formatFileSize(estimatedSizes.docx)} • Editable in Word
              </div>
            </div>
          </div>
          {loading === 'docx' ? (
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              <div className="font-medium text-gray-900">Google Doc</div>
              <div className="text-sm text-gray-500">
                {formatFileSize(estimatedSizes.googledoc)} • Upload to Drive
              </div>
            </div>
          </div>
          {loading === 'googledoc' ? (
      ...
      <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        <p className="text-sm text-blue-800">
          <strong>Google Doc Export:</strong> After downloading the DOCX file, upload it to{' '}
          <a
